import { UserRequestIcon } from '@/assets/Icons';
  ...
  const notifications: NotificationItem[] = [
    {
      ...
      fullName: 'Terry Franci',
      requestMessage: 'requests permission to change',
      object: 'Group: React Developers',
      time: '2 hours ago',
      type: 'Project',
      userStatus: 'online',
    },
            ...
            <li key={index}>
              ...
              >
                <span className="relative block w-full h-10 rounded-full z-1 max-w-10">
                  ...
                  <span
                    className={
                      (item.userStatus === 'busy' ? 'bg-error-500' : 'bg-success-500') +
