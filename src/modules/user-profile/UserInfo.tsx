              ...
              <div>
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div>
                    ...
                    <Input type="text" value="#" name="txtFb" />
                  </div>

                  <div>
                    <Label>X.com</Label>
                    <Input type="text" value="#" name="txtX" />
                  </div>

                  <div>
                    <Label>Linkedin</Label>
                    <Input type="text" value="#" name="txtLn" />
                  </div>

                  <div>
                    <Label>Instagram</Label>
                    <Input type="text" value="#" name="txtIns" />
                  </div>
                </div>
              </div>
              <div className="mt-7">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                  <div className="col-span-2 lg:col-span-1">
                    ...
                    <Input type="text" value="Musharof" name="txtFirstName" />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Last Name</Label>
                    <Input type="text" value="Chowdhury" name="txtLastName" />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Email Address</Label>
                    <Input type="text" value="randomuser@pimjo.com" name="txtEmail" />
                  </div>

                  <div className="col-span-2 lg:col-span-1">
                    <Label>Phone</Label>
                    <Input type="text" value="+09 363 398 46" name="txtFb" />
                  </div>

                  <div className="col-span-2">
                    <Label>Bio</Label>
                    <Input type="text" value="Team Manager" name="txtFb" />
                  </div>
                </div>
              </div>
            </div>
